...
variable "name_prefix"       { type = string, default = "mercor-demo" }
...
variable "ami_id"            { type = string,  default = null } # set to roll new AMI
variable "ecr_repo_name"     { type = string,  default = "mercor-ecs-demo" }
